...
// remove all active class on all menu items
...
// highlight messages search card when messages menu items is clicked 
...
// remove active class from font sizes selector
